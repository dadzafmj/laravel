...
class Patient extends Model
{
    ...
    protected $fillable = ['num_patient','num_court','nom_patient','prenom_patient','sexe','age','adress','num_dossier','tel','medecin_prescripteur','date_arrive','date_remise','jour_A','mois_A','annee_A','jour_R','mois_R','annee_R','lien_parente','unite_age','nom_agent','prenom_agent','sexe_agent','im_agent','adresse_agent','service_employeur','num_visa','date_visa','signataire_visa','fonction_signataire','nomfichier','hospitalisation','unite_admission','etat_patient','diagnostic_accueil','diagnostic_sortie','chambre_patient','lit_patient','categorie_patient','date_hospitalisation','decision_sortie','date_sortie'];
